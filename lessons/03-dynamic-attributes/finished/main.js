...
class NMADetails extends HTMLElement {
  // This tells the web component to watch
  // for changes in these attributes in the
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    // Update the specific elements with the 'newValue'
    // if they have been updated
    switch (name) {
      case "question":
        this.summaryElement.innerHTML = newValue;
        break;
      case "answer":
        this.answerElement.innerHTML = newValue;
        break;
    }
  }
